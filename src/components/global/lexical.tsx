...
export default function LexicalEditor() {
  ...
  const containerClasses = `w-full max-w-3xl mx-auto p-4 border rounded-2xl shadow-md transition-colors ${
    mode === "dark" ? "bg-gray-900 border-gray-700" : "bg-white border-gray-200"
  }`;

  const editableClasses = `min-h-[300px] p-2 outline-none transition-colors ${
